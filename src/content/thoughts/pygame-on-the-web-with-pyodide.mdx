...
```html title=index.html "my_module" "main()"
<!DOCTYPE html>
<html>
<head>
...
***Update:** I have also published the demo on Itch.io to showcase it working there, using the default web settings and manually set viewport dimensions. You can see it in action [here](https://createdbyseb.itch.io/pyodide-pygame-demo).*
